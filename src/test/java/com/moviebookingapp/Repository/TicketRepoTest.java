...
//		tickets.add(ticket);
//		//tickets.getMovie().getKey().getMovieName(),tickets.getMovie().getKey().getTheatreName()
//		List<Tickets> tickets1 =ticketRepo.findByMovieName(ticket.getMovie().getKey().getMovieName());
//		System.out.print("hello"+tickets1);
