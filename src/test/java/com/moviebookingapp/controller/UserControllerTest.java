...
class UserControllerTest {
	...
	@Test
	void loginTest() {
		when(userService.authenticate(user.getLoginId(),user.getPassword())).thenReturn(false);
		//assertEquals(new ResponseEntity<>(false,HttpStatus.OK), userController.loginAuth("nehal12", "123"));
	}
